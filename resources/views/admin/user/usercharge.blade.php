    ...
    <div class="page-container">
        ...
        <form>
            <div class="text-c">
                ...
                <input type="text" class="input-text"   value="{{ request()->get('ss') }}" style="width:250px" placeholder="输入用户名/平台账号进行搜索" id="" name="ss">
        ...
        <div class="cl pd-5 bg-1 bk-gray mt-20">
            ...
            <table class="table table-border table-bordered table-bg">
                <thead>
                <tr>
                    <th scope="col" colspan="11">玩家充值列表</th>
                </tr>
                <tr class="text-c">
